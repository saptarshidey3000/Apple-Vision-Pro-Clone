...
gsap.to("#page1>video", {
  ScrollTrigger: {
    trigger: `#page1>video`,
    start: `3% top`,
    end: `800% top`, // Significantly increase this to slow down the animation
    scroller: `#main`,
    scrub: 50, // Increase scrub value for even slower and smoother animation
  },
  onStart: () => {
...
gsap.to("#page1", {
  ScrollTrigger: {
    trigger: `#page`,
    start: `top top`,
    end: `800% top`, // Significantly increase this to slow down the pinning
    scroller: `#main`,
    pin: true,
    scrub: 50, // Increase scrub value for even slower and smoother pinning
  }
});
...
gsap.to("#page-bottom", {
  ...
  ScrollTrigger: {
    trigger: `#page-bottom`,
    start: `20% top`,
    end: `50% top`, // Adjust as needed
    scroller: `#main`,
    scrub: 2, // Smooth fade-in
  },
});
...
//     trigger: `#page-bottom`,
//     start: `50% top`,
//     end: `80% top`, // Adjust as needed
//     scroller: `#main`,
//     scrub: 2, // Smooth fade-out
//   },
// });
...
gsap.to("#page2 > p", {
  ...
  top: "-50%", // Move the <p> element 10% above its original position
});
